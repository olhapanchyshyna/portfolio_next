export const skillsData = [
  {
    column: [
      {
        title: "ByteGrad",
        subtitle: "Professional React & Next.js",
        description:
          "TypeScript, Tailwind, Hooks, Context API, state management (Zustand / RTK), App Router, server components, server actions, revalidation, SSR & SSG. Zustand, RHF (forms), Next-Auth, Stripe, Framer Motion, Shadcn-UI, Prisma, Postgres, Vercel ",
      },
      {
        title: "Campfire School",
        subtitle: "Complete Course on Typescript + React",
        description:
          "Full study TypeScript and practical application with React ",
      },
      {
        title: "Udemy (Ivan Petrychenko)",
        subtitle: "The Complete JavaScript + React Course Part 2",
        description:
          "A complete exploration of the React library in class and functional style",
      },
      {
        title: "Udemy (Ivan Petrychenko)",
